...
COCOLM_PRETRAINED_MODEL_ARCHIVE_MAP = {
    'microsoft/cocolm-base': "https://huggingface.co/microsoft/cocolm-base/blob/main/pytorch_model.bin",
    'microsoft/cocolm-large': "https://huggingface.co/microsoft/cocolm-large/blob/main/pytorch_model.bin",
}
    ...
    def forward(
        ...
        if labels is not None:
            if self.num_labels == 1:
                ...
                loss = loss_fct(
                    logits.view(-1, self.num_labels), labels.float().view(-1, self.num_labels))
